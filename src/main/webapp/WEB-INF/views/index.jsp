...
<div class="container">
	...
	<div class="row">
		...
		<div class="col-md-4" style="text-align: right">
			<h3>欢迎您，<%=request.getSession().getAttribute("userId") + "(" + request.getSession().getAttribute("userName") + ")" %></h3>
		</div>
	</div>
	<!-- 操作按钮 -->
	<div class="row">
		<div class="col-md-3 col-md-offset-10">
			...
			<button type="button" class="btn btn-warning" id="exit_user">退出</button>
		</div>
	</div>
	<br/>
	<!-- 表格 -->
...
<script type="text/javascript">
	...
	function build_page_info(res){
		$("#page_info").empty();
		$("#page_info").append("当前第"+res.extend.pageInfo.pageNum+"/" + res.extend.pageInfo.pages +"页，总共"+res.extend.pageInfo.total+"条记录");
	}
	//解析分页条
	...
	$("#exit_user").click(function(){
		...
		if(confirm("确认退出【" + userId + "(" + userName + ")" + "】用户吗？")){
			$.ajax({
				url:"${path}/logout",
				type:"GET",
				success:function(res){
